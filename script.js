...
const renderCalendar = () => {
  ...
  for (let dayPrevMonth = firstDayIndex; dayPrevMonth > 0; dayPrevMonth--) {
    days += `
        <div tabindex="0" class="prev-date day-month">
  ...
  for (let day = 1; day <= lastDayCurrentMonth; day++) {
    if (
      ...
      days += `
            <div tabindex="0" class="today day-month">
                <div class="day_unit_header">
                    <div class="display_events"></div>
                    <button class="btn_day"><i class="fas fa-plus"></i></button>
                </div>
      ...
      days += `
            <div tabindex="0" class="day-month">
                <div class="day_unit_header">
                    <div class="display_events">
                        <p class="event_preview">Event Title</p>
                    </div>
                    <button class="btn_day"><i class="fas fa-plus"></i></button>
                </div>
            <p class="calendar_day">${day}</p>
  ...
  for (
    let dayNextMonth = 1;
    dayNextMonth <= firstDaysPrevMonth;
    dayNextMonth++
  ) {
    days += `
        <div tabindex="0" class="next-date day-month">
        <div class="day_unit_header">
            <div class="display_events"></div>
                <button class="btn_day"><i class="fas fa-plus"></i></button>
            </div>
